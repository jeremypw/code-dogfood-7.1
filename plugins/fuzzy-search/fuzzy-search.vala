...
public class Scratch.Plugins.FuzzySearch: Peas.ExtensionBase, Peas.Activatable {
    ...
    public void activate () {
        ...
        plugins.hook_window.connect ((w) => {
            ...
            folder_settings = new GLib.Settings ("com.github.jeremypw.dogfood-code-flatpak-7.folder-manager");
            add_actions ();
    ...
    private void fuzzy_find () {
        var settings = new GLib.Settings ("com.github.jeremypw.dogfood-code-flatpak-7.folder-manager");
